...
```python
from src.exps.estimate_correlated_inner_product import plot_distortion_rho
...
# Rate-distortion experiments and analysis
from src.exps.estimate_inner_product import plot_distortion_rate, find_best_beta
...
### Rate-Distortion Experiments (`src.exps`)
