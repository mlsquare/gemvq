...
from .adaptive_matvec import AdaptiveMatVecProcessor


def create_test_data(
    m: int, n: int, sparsity_ratio: float = 0.2
...
def performance_comparison(
    ...
    start_time = time.time()
    adaptive_result = AdaptiveMatVecProcessor.adaptive_matvec_multiply(
    ...
    start_time = time.time()
    adaptive_lookup_result = AdaptiveMatVecProcessor.adaptive_matvec_multiply(
    ...
    processor = AdaptiveMatVecProcessor(
...
def demo_basic_usage():
    ...
    result = AdaptiveMatVecProcessor.adaptive_matvec_multiply(
...
def demo_rate_allocation():
    ...
    for strategy in strategies:
        ...
        if strategy == "uniform":
            ...
            modified_rates = target_rates * 1.2  # Increase all rates by 20%
        else:  # adaptive
