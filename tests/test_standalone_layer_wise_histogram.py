"""
Simple test for the standalone layer-wise histogram implementation.

This test avoids any parameter optimization and focuses on testing the core algorithm.
"""
...
from src.adaptive.standalone_layer_wise_histogram import (
...
def test_paper_example():
    """Test the standalone implementation against the paper example."""
    print("Testing Standalone Layer-Wise Histogram MatVec")
    print("=" * 60)
    ...
    # Note: Our simple codebook gives slightly different results
    # but the methods should agree with each other
    ...
    # Check if methods agree with each other
...
def test_simple_example():
    ...
    M_j = [2, 2, 1, 2]  # column 3 uses only 1 layer
    
    x = np.array([1.0, -1.0, 0.0, 2.0])
    
    print(f"Parameters: n={n}, d={d}, M={M}, q={q}")
...
def main():
    """Run all tests."""
    print("Standalone Layer-Wise Histogram MatVec Implementation Tests")
    print("=" * 80)
